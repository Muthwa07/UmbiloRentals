...
namespace UmbiloRentals.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public ActionResult ForgotPassword(string email)
        {
            ...
            {
                // Fail safely: keep the reset code in the database so support staff can still assist,
                // but do not claim an email was sent if the SMTP stack is not configured.
            }
